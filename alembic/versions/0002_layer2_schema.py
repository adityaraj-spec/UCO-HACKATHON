...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("phone_nonce", sa.LargeBinary(12), nullable=False),
        sa.Column("encrypted_email", sa.LargeBinary(), nullable=False),
        sa.Column("email_nonce", sa.LargeBinary(12), nullable=False),
        sa.Column("key_id", sa.String(length=128), nullable=False, server_default="phaseguard-master-key-v1"),
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default="true"),
